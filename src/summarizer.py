...
5. rating：1~5 的整數，代表「對想用 AI 一人創業的讀者」的幫助程度。
   5 = 有具體營收數字＋可複製做法的一人 AI 案例；3 = 有參考價值但資訊不完整；
   1 = 只是沾邊。請誠實給分，不要每則都給高分。
   【硬規則】內文完全沒有收錢的證據（營收/MRR/定價/付費用戶數，至少一項有具體數字
   或明確說有人付費）的案例，rating 最高只能給 2——就算故事再精彩也一樣。
   免費產品、純心得文、還沒開始收費的專案，都屬於這類。
   insight 裡必須寫出那個收錢的證據（例如「MRR $8k」「付費用戶 300 人」）。
6. 最多輸出 {max_items} 則，依 rating 由高到低排序。
7. 嚴格只回傳 JSON，不要有 markdown 圍欄或多餘文字。

輸出格式：
{{
  "headline": "今日案例一句話總覽",
  "items": [
    {{"title": "精簡標題（含營收數字更好）", "rating": 4, "insight": "案例做什麼、成果、怎麼做到", "takeaway": "對讀者的一句話啟發", "barrier": "門檻與天花板", "mvp": "素人今天能動手的最小版本", "source": "來源", "url": "原文連結"}}
  ]
}}
"""
